...
a = ["muskan", "siddhika", "varsha", 10]
print(len(a))
print(type(a))

b = ("muskan", "siddhika", "varsha", 10 , True)
print(len(b))
print(type(b))

c = {"muskan", "siddhika", "varsha", 10 , 12.60 , False}
print(len(c))
print(type(c))

d = {"name" : "muskan" , "age" : 17 , "sex" : "female" , "hobby" : "yapping"}
print(d["hobby"])
...
students_marks = {"muskan": 100 , "tannu": 12 , "varsha": -30, "siddhika" : 0 , "anurag" : 1}
